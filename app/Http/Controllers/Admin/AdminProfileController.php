...
class AdminProfileController extends Controller
{
    ...
    public function store(User $user, Request $request)
    {
        ...
        if ($user->save()) {
            ...
            return redirect()->route('admin.profile.view')->with('error', 'Something went wrong. Please try again!');
        }
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if(Storage::exists('public/media/images/admin/profile-photo/'.$user->photo)){
                Storage::delete(['public/media/images/admin/profile-photo/'.$user->photo]);
            }
            $photo->storeAs('media/images/admin/profile-photo',$photoName,'public');
            $filename = 'media/images/admin/profile-photo/'.$photoName;
        } else {
    ...
    public function destroy(User $user, $type, StatefulGuard $guard, Request $request)
    {
        if ($type == 'photo') {
            ...
            if ($user->save()) {
                return redirect()->route('admin.profile.view')->with('success', 'Profile photo has been successfully removed.');
            } else {
                return redirect()->route('admin.profile.view')->with('error', 'Something went wrong. Please try again!');
            }
        }
